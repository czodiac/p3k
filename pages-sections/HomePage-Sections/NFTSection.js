    ...
    <div className={classes.section}>
      <GridContainer justify="center">
        <GridItem xs={12} sm={12} md={12}>
          ...
          <h5 className={classes.description}>
            ...
            types: Platinum, Gold, Silver and Bronze.
          </h5>
        </GridItem>
      </GridContainer>
      <GridContainer className={classes.gridPadding}>
        <GridItem xs={6} sm={4} md={4}>
          ...
          many soldiers die in a battle. Your soldiers are less likely die in a
          battle if this value is high. This value is important for all types of
          battle(1 on 1 and normal). However, it is a bit more useful for 1 on 1
          battles. <a href="#">This</a> describes it in details.
        </GridItem>
        <GridItem xs={6} sm={4} md={4}>
          <img alt="..." height={30} src="img/nft/brain.png" />
          <h4 className={classes.subTitle}>Intelligence</h4>
          Same as strength attribute. The only difference is that this value is
          a bit more useful for normal battles than 1 on 1 battles.{" "}
          <a href="#">This</a> describes it in details.
        </GridItem>
        <GridItem xs={6} sm={4} md={4}>
          <img alt="..." height={30} src="img/nft/charm.png" />
          <h4 className={classes.subTitle}>Attraction</h4>
          Every day your hero recruites soldiers. Higher attraction value helps
          you to grow your soldiers faster. You have better chancing of winning
          a battle if you have more soldiers.
          <a href="#">This</a> describes it in details.
        </GridItem>
      </GridContainer>
      <GridContainer>
        <GridItem xs={6} sm={3} md={3}>
          ...
          Platinum is the only type was chosen manually by creator and platinum
          card does not necessarily mean the hero's stats are high. However,
          these heroes will increase the change of winning battles. You can find
          who they are <a href="#">here</a>.
        </GridItem>
        <GridItem xs={6} sm={3} md={3}>
